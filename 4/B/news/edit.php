            ...
            if($ukuran > 0) {
                if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
                    if($ukuran < 1044070){
                        ...
                        if ($terupload) {
                            $query = " UPDATE tb_news SET title = '$title', deskripsi = '$deskripsi', user_id = '$user_id' WHERE id = '$id'  ";
                            $data = mysqli_query($con, $query);
                            if($data){
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-8 col-md-9">
                                        <input type="text" class="form-control form-control-sm" name="title" id="title" required value="<?php echo $row['title'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8 col-md-9">
                                        <textarea name="deskripsi" id="deskripsi" class="form-control form-control-sm" rows="5"><?php echo $row['deskripsi'] ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-8 col-md-9">
                                        ...
                                        <?php while($rows = mysqli_fetch_assoc($user)) { ?>
                                            <option value="<?php echo $rows['id'] ?>" <?php if($row['user_id'] ==  $rows['id']){echo "selected";} ?> >
                                                <?php echo $rows['nama'] ?>
                                            </option>
                                        <?php } ?>
                                        </select>
